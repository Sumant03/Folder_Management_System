...
function GridTwo({setIsOpen,items}:Props){
      ...
      {items?.map((item: DataTypes, idx: number) => (
        <>
         ...
         <div
          ...
          key={idx}
          className="gt6666ColumnGridTwo">
          {item.isFolder ? (
            <div className="gt6666ContainerGridTwo">

              <div className="gt6666FolderDiv">

                 <img src={folder} className="gt6666PicGridTwo" />
       
                  <div className="hp6666Name">{item.name.slice(0, 8)}</div>
              </div>

              <div className="hp6666Name">{item.type}</div>
              <div className="hp6666Name">{item.creator}</div>
              <div className="hp6666Name">{item.createdAt}</div>
            ...
            <div className="gt6666ContainerGridTwo">
                    ...
                    <img src={fileIcon} className="gt6666PicGridTwo" />
                ...
                {item?.children?.map((data: DataTypes, idx: number) => (
              <div key={idx} className="hp6666Nestedgrid">
                <GridTwo items={item.children} setIsOpen={setIsOpen} />
              </div>
            ))}
